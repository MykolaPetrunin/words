...
import { createBook, updateBook, type BookInput, type DbBookWithSubjects } from '@/lib/repositories/bookRepository';
...
export async function createAdminBook(data: BookFormData): Promise<DbBookWithSubjects> {
...
export async function updateAdminBook(bookId: string, data: BookFormData): Promise<DbBookWithSubjects> {
    const parsed = bookFormSchema.parse(data);
