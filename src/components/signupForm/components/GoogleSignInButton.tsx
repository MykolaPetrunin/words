...
export const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({ disabled = false }) => {
    ...
    return (
        <Button type="button" variant="outline" className="w-full" onClick={handleGoogleSignIn} disabled={disabled || isLoading}>
            ...
            {isLoading ? 'Увійти через Google...' : 'Увійти через Google'}
        </Button>
    );
};
